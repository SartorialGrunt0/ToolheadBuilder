...
The 3D printer probe is responsible for measuring the distance between the too FDM 3D printers, responsible for melting plastic from a solid to a molten state.
